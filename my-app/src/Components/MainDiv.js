...
function displayPage(){
    if(showModal){
        ...
        return(
        <div className='grid grid-cols-2 font-newFont sm:grid-cols-12 sm:pt-8 sm:h-screen  md:max-w-3xl lg:max-w-screen-lg desktop:max-w-screen-xl  m-auto lg:max-h-mainDiv relative'>
            <div className='col-span-2 sticky top-0 sm:col-start-2 lg:col-start-1 my-auto  lg:place-self-end sm:place-self-end sm:mt-4 sm:-mr-4 desktop:mt-40 lg:mt-28 z-50 ' >
