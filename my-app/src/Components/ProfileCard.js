...
function ProfileCard(props){
    ...
    return (
        <div className= "bg-blue-50  w-full drop-shadow-xl rounded-md mb-4  mx-auto max-w-lg lg:col-span-5 lg:shadow-2xl lg:h-5/6 relative z-40">
            <img src={ProfilePic} className='object-cover mx-auto rounded-md pb-4 w-full'/>
            <p className="text-5xl">Tripp White</p>
            <p className="text-2xl">Software Engineer</p>
            <div className='flex flex-row justify-between w-1/2 mx-auto pb-16 lg:pb-0'>
            ...
            <div className='flex justify-around h-16 items-center absolute bottom-0 w-full border-t-2' >
                <div className=''>
