    ...
    return(
        <div className="flex w-full bg-white rounded-sm p-4">
            <div className='flex-1 overflow-auto'>
                ...
                <hr></hr>
                <div className="grid grid-cols-2 pl-2 pt-1 text-left">
                ...
                <p className=' font-newFont text-2xl font-bold p-2 text-left'>Fun Facts</p>
               
                <div className='grid grid-cols-4 '>
                    <div className='border-t-4 border-r-4 grid justify-items-center' >
                        <div>
